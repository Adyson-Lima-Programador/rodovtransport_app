...
class UsuariosService {
  static Future<List<Usuario>> buscarTodos() async {
    ...
    var url = Uri.parse("https://rodovtransport.herokuapp.com/api/v2/users");
  ...
  static Future<List<Usuario>> navegarPagina(int paginaAtual) async {
    // Padrão de url para produção
    var url = Uri.parse("https://rodovtransport.herokuapp.com/api/v2/users?page=$paginaAtual");
  ...
  Future<bool> atualizar(int id, String email, String name, String password,
    ...
    // Padrão de url para produção
    var url = Uri.parse("https://rodovtransport.herokuapp.com/api/v1/users/${id.toString()}");
  ...
  Future<bool> excluir(int id) async {
    // Padrão de url para produção
    var url = Uri.parse("https://rodovtransport.herokuapp.com/api/v2/users/$id");
